...
# Dicionário para armazenar as listas dos primeiros 5 valores
column_data = {}
...
# Dicionário para armazenar o Teste de Tukey as listas dos valores 6 a 10
tukeyA = {}
for column in df.columns:
...
# Dicionário para armazenar os erros as listas dos valores 11 a 15
uncertaintyA = {}
for column in df.columns:
...
x = np.arange(len(tratamentos))  # Posições no eixo X
width = 0.25  # Espessura das barras

# Preparar a legenda customizada em formato de retângulo
legend_elements = [
...
# Definimos a figura com 4 plots em formato 2 por 2
# Tamano e definição
# Definimos que os subplots vão compartilhar os eixos X e Y
